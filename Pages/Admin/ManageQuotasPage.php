...
//Class: Supports the quota configuration controller
class ManageQuotasPage extends ActionPage implements IManageQuotasPage
{
	 ...
	 * @return void
	 */
	//Sends the group information to the Smarty page
	public function BindGroups($groups)
	{
	 ...
	 * @return string
	 */
	//Gets duration selected by user
	public function GetDuration()
	{
	 ...
	 * @return int
	 */
	//Gets resource selected by user
	public function GetResourceId()
	{
