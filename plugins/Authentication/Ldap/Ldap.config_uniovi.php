...
$conf['settings']['host'] = 'ldaps://directorio.uniovi.es'; // comma separated list of ldap servers such as mydomain1,localhost
...
$conf['settings']['binddn'] = 'uid=uo204462,ou=Alumnos,dc=uniovi,dc=es';	// The distinguished name to bind as (username). If you don't supply this, an anonymous bind will be established.
$conf['settings']['bindpw'] = '825057';	// Password for the binddn. If the credentials are wrong, the bind will fail server-side and an anonymous bind will be established instead. An empty bindpw string requests an unauthenticated bind.
$conf['settings']['basedn'] = 'uid=uo204462,ou=Alumnos,dc=uniovi,dc=es';	// LDAP base name (eg. dc=example,dc=com)
