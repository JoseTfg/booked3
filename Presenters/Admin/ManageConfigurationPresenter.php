...
//Class: Supports the configuration controller
class ManageConfigurationPresenter extends ActionPresenter
{
	...
	//Gets the path of the selected configuration file
...
//Class: Each of the config files
...
//Class: Type of the config setting
