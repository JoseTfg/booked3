...
$conf['settings']['script.url'] = 'http://156.35.41.127/booked/Web';
...
$conf['settings']['home.url'] = 'http://156.35.41.127/booked/Web';
...
$conf['settings']['Jose_Szklarz de Quesada#minTime'] = '06:00';
$conf['settings']['Jose_Szklarz de Quesada#maxTime'] = '18:00';
$conf['settings']['Admin_Admin#minTime'] = '10:00';
$conf['settings']['Admin_Admin#maxTime'] = '20:00';
$conf['settings']['Admin_Admin#color#Conference Room 1'] = '';
$conf['settings']['Jose_Szklarz de Quesada#color#Conference Room 2'] = '';
$conf['settings']['user3_user3#minTime'] = '10:00';
$conf['settings']['user3_user3#maxTime'] = '20:00';
$conf['settings']['Jose_Szklarz de Quesada#color#Conference Room 1'] = '';
$conf['settings']['Jose_Szklarz de Quesada#color#Despacho 1'] = '';
$conf['settings']['Jose_Szklarz de Quesada#color#Despacho 2'] = '';
$conf['settings']['Víctor Manuel_Gonzáles Suárez#color#Aula de Exámenes'] = '';
$conf['settings']['Jose_Szklarz de Quesada#color#aa'] = '';
$conf['settings']['Jose_Szklarz de Quesada#color#Aula de Exámenes'] = '';
$conf['settings']['Víctor Manuel_Gonzáles Suárez#color#aa'] = '';
?>