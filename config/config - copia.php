...
//date_default_timezone_set($conf['settings']['default.timezone']);		// MyCode
...
$conf['settings']['script.url'] = 'http://localhost/booked/Web';   		// public URL to the Web directory of this instance.
...
$conf['settings']['registration.notify.admin'] = 'false';				// whether the registration of a new user sends an email to the admin
$conf['settings']['inactivity.timeout'] = '';     						// minutes before the user is automatically logged out MyCode(8/3/2016)
$conf['settings']['name.format'] = '{first} {last}';     				// display format when showing user names
$conf['settings']['css.extension.file'] = ''; 			      			// full or relative url to an additional css file to include.
																		// this can be used to override the default style
...
$conf['settings']['default.homepage'] = '3'; 	      					// the default homepage to use when new users register
																		// (1 = Dashboard, 2 = Schedule, 3 = My Calendar, 4 = Resource Calendar)
...
$conf['settings']['uploads']['reservation.attachment.path'] = 'uploads/reservation'; 	// full or relative filesystem path to store reservation attachments
$conf['settings']['uploads']['reservation.attachment.extensions'] = 'txt,jpg,gif,png,doc,docx,pdf,xls,xlsx,ppt,pptx,csv'; 	
// comma separated list of file extensions that users are allowed to attach. leave empty to allow all extensions
/**
