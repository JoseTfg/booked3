...
interface IPruebaPageBuilder
{
	 ...
	 */
	public function BindSchedules(IPruebaPage $page, $schedules, $currentSchedule);
	 ...
	 * @return Schedule
	 */
	public function GetCurrentSchedule(IPruebaPage $page, $schedules, UserSession $user);
	 ...
	 * @return DateRange
	 */
	public function GetScheduleDates(UserSession $userSession, ISchedule $schedule, IPruebaPage $page);
	 ...
	 * @param ISchedule $schedule
	 */
	public function BindDisplayDates(IPruebaPage $page, DateRange $dateRange, ISchedule $schedule);
	 ...
	 */
	public function BindReservations(IPruebaPage $page, $resources, IDailyLayout $dailyLayout);

	/**
	 * @param ISchedulePage $page
	 * @param ResourceGroupTree $resourceGroupTree
	 */
	public function BindResourceGroups(IPruebaPage $page, ResourceGroupTree $resourceGroupTree);

	/**
	 * @param ISchedulePage $page
	 * @param ResourceType[] $resourceTypes
	 */
	public function BindResourceTypes(IPruebaPage $page, $resourceTypes);
	 ...
	 * @return int
	 */
	public function GetGroupId($scheduleId, IPruebaPage $page);
	 ...
	 * @return int
	 */
	public function GetResourceId($scheduleId, IPruebaPage $page);
	 ...
	 */
	public function GetResourceFilter($scheduleId, IPruebaPage $page);
	 ...
	 */
	public function BindResourceFilter(IPruebaPage $page, ScheduleResourceFilter $filter, $resourceCustomAttributes,
									   $resourceTypeCustomAttributes);
}

class PruebaPageBuilder implements IPruebaPageBuilder
{
	/**
	 * @param ISchedulePage $page
	 * @param array[int]ISchedule $schedules
	 ...
	 */
	public function GetScheduleDates(UserSession $user, ISchedule $schedule, IPruebaPage $page)
	{
