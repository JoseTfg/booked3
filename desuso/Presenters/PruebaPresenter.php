...
require_once(ROOT_DIR . 'Presenters/PruebaPageBuilder.php');
require_once(ROOT_DIR . 'Presenters/ActionPresenter.php');

interface IPruebaPresenter {

    public function PageLoad(UserSession $user);
}

class PruebaPresenter extends ActionPresenter implements IPruebaPresenter {
    ...
    public function __construct(
        ...
        IPruebaPageBuilder $schedulePageBuilder,
