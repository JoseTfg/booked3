...
require_once(ROOT_DIR . 'Presenters/PruebaPresenter.php');

interface IPruebaPage extends IActionPage
{
	/**
...
class PruebaPage extends ActionPage implements IPruebaPage
{
	...
	public function __construct()
	{
		...
		$pageBuilder = new PruebaPageBuilder();
		...
		$this->_presenter = new PruebaPresenter($this, $scheduleService, $resourceService, $pageBuilder, $reservationService, $dailyLayoutFactory);
	}
	...
	public function ProcessPageLoad()
	{
		...
		{
			$this->Display('Calendar/calendar.common.tpl');
		}
