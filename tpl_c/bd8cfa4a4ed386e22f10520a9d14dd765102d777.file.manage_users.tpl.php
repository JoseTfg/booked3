<?php /* Smarty version Smarty-3.1.16, created on 2016-05-17 15:04:48
         compiled from "C:\Program Files (x86)\Ampps\www\booked\tpl\Admin\manage_users.tpl" */ ?>
<?php /*%%SmartyHeaderCode:25712573b16f041bf72-58298061%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '25712573b16f041bf72-58298061',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_573b16f06b6f75_66394127',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_573b16f06b6f75_66394127')) {function content_573b16f06b6f75_66394127($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include 'C:\\Program Files (x86)\\Ampps\\www\\booked\\lib\\Common/../../lib/external/Smarty/plugins\\function.cycle.php';
...
<table class="list userList" id="userTable">
	...
	<tr>
		...
		<td class="action"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Groups'),$_smarty_tpl);?>
</th>
...
?>
 ...
 editable">
			<td class="id" align="center"><input type="hidden" class="id" value="<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
"/></td>
			<td id="<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
" align="center"><?php echo $_smarty_tpl->tpl_vars['user']->value->Username;?>
</td>
			<td align="center"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fullname'][0][0]->DisplayFullName(array('first'=>$_smarty_tpl->tpl_vars['user']->value->First,'last'=>$_smarty_tpl->tpl_vars['user']->value->Last,'ignorePrivacy'=>"true"),$_smarty_tpl);?>
</td>			
			<td align="center"><a href="mailto:<?php echo $_smarty_tpl->tpl_vars['user']->value->Email;?>
"><?php echo $_smarty_tpl->tpl_vars['user']->value->Email;?>
			...
			<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['statusDescriptions']->value[$_smarty_tpl->tpl_vars['user']->value->StatusId];?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Active'),$_smarty_tpl);?>
<?php $_tmp2=ob_get_clean();?><?php if ($_tmp1==$_tmp2) {?> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>'tick-circle.png'),$_smarty_tpl);?>

			<?php } else { ?> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>'slash.png'),$_smarty_tpl);?>

			<?php }?>
			</a></td>
			<td align="center"><a href="#" class="update changePermissions"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>'my_edit.png'),$_smarty_tpl);?>
</a></td>
			<td align="center"><a href="#" class="update changeGroups"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>'my_edit.png'),$_smarty_tpl);?>
</a></td>
...
<button type="button" style="float:right;" class="button save" onclick="reset();"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>"reset.png"),$_smarty_tpl);?>
...
<input type="text" style="float:right;" placeholder="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'FindUser'),$_smarty_tpl);?>
" id="userSearch" class="textbox">
...
<div id="groupsDialog" class="dialog" style="background-color:#FFCC99;" title="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Groups'),$_smarty_tpl);?>
">
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['jsfile'][0][0]->IncludeJavascriptFile(array('src'=>"enhancement/userEnhance.js"),$_smarty_tpl);?>
