		...
		<form id="addBlackoutForm" method="post">
			<ul>
				<li>
					...
					|
					<label for="allResources">{translate key=AllResourcesOn} </label> <input {formname key=BLACKOUT_APPLY_TO_SCHEDULE} type="checkbox" id="allResources" />
				...
				<li>
					...
					<button type="button" id="createButton" class="button save create"> {html_image src="tick-circle.png"} {translate key='Create'}
					</button>
				</li>
				<li>
...
<div id="deleteDialog" class="dialog" title="{translate key=Delete}">
	<form id="deleteForm" method="post">
		<div id="marginError" class="error">
...
<div id="deleteRecurringDialog" class="dialog" title="{translate key=Delete}">
...
<div id="createDiv" class="creating">
	<div id="creating">
		<h3>{translate key=Working}</h3>
		{html_image src="reservation_submitting.gif"}
	</div>
	<div id="result" class="hiddenDiv"></div>
</div>
