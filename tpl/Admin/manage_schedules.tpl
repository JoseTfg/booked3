...
{foreach from=$Schedules item=schedule}
	...
	{*<a style="float:right" class="update changeButton" href="javascript:void(0);">{translate key=Change}</a><br/>*}
	{*<a class="update changeLayoutButton" href="javascript: void(0);">{translate key=ChangeLayout}</a>*}
	<button style="float:right" type="button" class="update changeButton">{html_image src="my_edit.png"} {translate key=Change}</button>
	</br>
	</br>
	<button style="float:right" type="button" class="update changeLayoutButton">{html_image src="my_edit.png"}{translate key=ChangeLayout}</button>
        ...
        <div style="display:none;" class="layout">
...
<div id="changeSettingsDialog" class="dialog" style="display:none;background-color:#FFCC99" title="{translate key=Change}">
	...
	{translate key=StartsOn}:
        ...
        <br/>
		<br/>
	{translate key=NumberOfDaysVisible}: {*<select id="daysVisible" class="textbox required" {formname key=SCHEDULE_DAYS_VISIBLE}> 
	...
	<input type="text" class="textbox required" id="daysVisible" maxlength="3"
                                                size="3" {formname key=SCHEDULE_DAYS_VISIBLE} />
        <br/><br/>
        <button type="button" style="float:right;" class="button save">{html_image src="tick-circle.png"} {translate key=Update}</button>
        {*<button type="button" class="button cancel">{html_image src="slash.png"} {translate key=Cancel}</button>*}
    </form>
</div>

<div id="changeLayoutDialog" class="dialog" style="display:none;background-color:#FFCC99">
    ...
    <form id="changeLayoutForm" method="post">
        ...
        <div class="clear;display:block;" style="height:20px;display:none;">
	...
	{function name=display_slot_inputs}
        <div style="display:none;" class="clear" id="{$id}">
        ...
        <div style="margin-top: 5px; padding-top:5px; border-top: solid 1px #f0f0f0;">
            <div>
                <button style="float:right;" type="button"
                        class="button save-create">{html_image src="tick-circle.png"} {translate key=Update}</button>
                {*<button type="button" class="button cancel">{html_image src="slash.png"} {translate key=Cancel}</button>*}
            </div>
           {* <div>
