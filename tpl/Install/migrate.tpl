...
<div class="migratingElements hidden">Migrating <span class="elementType"></span> {html_image src="admin-ajax-indicator.gif"}</div>
...
<div id="errorContents" class="hidden"></div>
<div>
	{if $StartMigration}
